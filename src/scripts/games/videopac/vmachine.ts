...
export const LINECNT: number = 21;
export const MAXLINES: number = 500;
export const MAXSNAP: number = 50;

export const VBLCLK: number = 5493;
export const EVBLCLK_NTSC: number = 5964;
export const EVBLCLK_PAL: number = 7259;

export const FPS_NTSC: number = 60;
export const FPS_PAL: number = 50;

export class VirtualMachine {
  public dbstick1: number = 0; // uint8_t
  public dbstick2: number = 0; // uint8_t
  public lastLine: number = 0; // int

  public evblclk: number = 0; // int

  public masterClock: number = 0; // int /* Master clock */
  public intClock: number = 0; // int /* counter for length of /INT pulses for JNI */
  public horizontalClock: number = 0; // int /* horizontal clock */
  public coltab: Uint8Array = new Uint8Array(new ArrayBuffer(256)); // uint8_t [256]
  public mstate: number = 0; // int

  public romTable: Uint8Array[] = [
  ...
  public intRAM: Uint8Array = new Uint8Array(new ArrayBuffer(0));
  public extRAM: Uint8Array = new Uint8Array(new ArrayBuffer(0));
  public extROM: Uint8Array = new Uint8Array(new ArrayBuffer(0));
  public VDCwrite: Uint8Array = new Uint8Array(new ArrayBuffer(256));
  public ColorVector: Uint8Array = new Uint8Array(new ArrayBuffer(MAXLINES));
  public AudioVector: Uint8Array = new Uint8Array(new ArrayBuffer(MAXLINES));
  public rom: number = 0;
  public megarom: number = 0;

  public frame: number = 0;
  public key2: Uint8Array = new Uint8Array(new ArrayBuffer(128)); // int [128]
  public key2vcnt: number = 0;
  public clockCounter: number = 0;

  public enahirq: number = 0;
  public pendirq: number = 0;
  public useforen: number = 0;
  public regionoff: number = 0;
  public sproff: number = 0;
  public tweakedaudio: number = 0;
