...
export class Logic extends EntityBase {
  ...
  public constructor(engine: Engine) {
    ...
    document.addEventListener(
      'keydown',
      this.keyboardDownHandler.bind(this),
      false
    );
    document.addEventListener(
      'keyup',
      this.keyboardUpHandler.bind(this),
      false
    );
  }
  ...
  public render(context: CanvasRenderingContext2D): void {
    ...
    context.fillRect(
      ...
      this.engine.width * this.engine.renderer.scale,
      this.engine.height * this.engine.renderer.scale
    );
